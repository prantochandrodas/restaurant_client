...
const Events = () => {
    return (
        <div style={{ backgroundImage: `url(${bannerImage})`, backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundSize: 'cover' }} className='lg:mt-10 mt-4'>
            <div data-aos="zoom-in" data-aos-duration="1000" className='lg:px-20 px-5 lg:py-20 py-10'>
